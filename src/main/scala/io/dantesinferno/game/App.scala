        ...
        World(WorldState(
          ...
          triggeredQuotes = List(
            ...
            7200D -> List(
              ...
              ("DanteState", "Moat?", Some(6800D), Some(1000)),
              ("DanteState", "Did you mean... river of blood, perhaps?", Some(6800D), Some(2000)),
              ...
              ("ChironState", "Sure, 5 Drachma", Some(6800D), Some(2000)),
              ("VirgilState", "I only carry Denarii", Some(6800D), Some(2000)),
              ("ChironState", "Exhange rate is 3:1", Some(6800D), Some(2000)),
              ("VirgilState", "... fine.", Some(6800D), Some(1000)),
              ("ChironState", "Nessus!", Some(6800D), Some(1000)),
              ("ChironState", "\"Go back and guide them\" (92)", Some(6800D), Some(2000)),
              ("ChironState", "and then come back in time for dinner!", Some(6800D), Some(2000)),
              ("CentaurState", "k", Some(6800D), Some(1000)),
              ("DanteState", "What do they even eat down here?", Some(6800D), Some(2000)),
              ("VirgilState", "Don't ask.", Some(6800D), Some(2000))
            ),
            9500D -> List(
